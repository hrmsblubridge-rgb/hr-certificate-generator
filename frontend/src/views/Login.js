  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-[#efe6e0] py-14 px-6">
      <div className="flex-1 w-full flex flex-col items-center justify-center">
        ...
        >
          <h1 className="text-3xl font-bold text-[#0a1024] text-center">
            Welcome back
          </h1>
          ...
          <label className="block mb-5">
            <span className="block text-sm font-medium text-[#0a1024]/80 mb-2">
              Username
            </span>
            <div className="flex items-stretch bg-[#efe6e0]/70 border border-transparent focus-within:border-[#0a1024]/30 rounded-lg overflow-hidden transition-colors">
              <span className="grid place-items-center w-12 text-[#0a1024]/45">
                <User size={16} />
              </span>
              <input
          ...
          <div className="flex justify-end mb-6">
            <button
              ...
              onClick={() =>
                alert(
                  "Please contact your HR administrator to reset the BluBridge HRMS password."
                )
              }
